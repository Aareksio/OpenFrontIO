// PathFinder adapter for NavMeshOptimized

import { Game } from "../../game/Game";
import { TileRef } from "../../game/GameMap";
import { PathFinder, PathResult, PathStatus } from "../PathFinder";
import { NavMeshOptimized } from "./NavMeshOptimized";

export class NavMeshOptimizedAdapter implements PathFinder {
  private navMesh: NavMeshOptimized;
  private pathIndex = 0;
  ...
  constructor(
    private game: Game,
    options: { cachePaths?: boolean } = {},
  ) {
    this.navMesh = new NavMeshOptimized(game, {
      cachePaths: options.cachePaths ?? false,
    });
